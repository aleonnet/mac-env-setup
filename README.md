...
- **`~/.config/starship.toml`** — prompt com paleta Event Horizon (âmbar `#f5b000`); backup antes de sobrescrever. Escolher Powerlevel10k mantém seu `~/.p10k.zsh` intacto e instala a MesloLGS (fonte recomendada do p10k).
